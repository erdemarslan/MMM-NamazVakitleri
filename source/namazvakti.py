...
class namazvakti():
    ...
    # Başlatma metodu
    def __init__(self, cacheklasoru = None, mainKlasor=None):
        # Dosya yolumuzu belirtelim
        if mainKlasor != None:
            self.__dosyaYolu = mainKlasor
        else:
            self.__dosyaYolu = os.getcwd()
        ...
        if cacheklasoru != None:
            ...
            self.__cache = os.path.join(self.__dosyaYolu, self.__cacheKlasorYolu)

        # veritabanını oluştur!
        yerler = os.path.join(self.__dosyaYolu, "db", "yerler.ndb")
    ...
    def __yerBilgisi(self, sehir_id):
        ...
        # adres dosyası
        adresDosyasi = os.path.join(self.__dosyaYolu, "db", "adresler.ndb")
